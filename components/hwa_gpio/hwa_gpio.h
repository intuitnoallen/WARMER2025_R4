...
typedef struct
{
    ...
    /** @brief  Context data specific for GPIO_EVT_EDGE_DETECTED */
    struct
    {
        uint8_t     u8_level;               //!< Current level of the associated GPIO pin
        bool        b_active;               //!< Indicates if the associated GPIO pin is active or not
    } stru_state;
