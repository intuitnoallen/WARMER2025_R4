...
#endif /* CONFIG_USE_PRE_ENC_OTA */

#endif /* CONFIG_USE_PROTOCOMM */

    xTaskCreate(&ota_task, "ota_task", OTA_TASK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL); //8
}
